...
legup_memset_4_i64.exit:                          ; preds = %encode.exit._crit_edge, %legup_memset_4_i64.exit.preheader
  ...
  %ph1.0 = phi i32 [ %209, %encode.exit._crit_edge ], [ 0, %legup_memset_4_i64.exit.preheader ]
  ...
  %plt1.0 = phi i32 [ %137, %encode.exit._crit_edge ], [ 0, %legup_memset_4_i64.exit.preheader ]
...
; <label>:113                                     ; preds = %115
  %114 = icmp slt i32 %117, 30
  br i1 %114, label %115, label %quantl.exit.i

; <label>:115                                     ; preds = %113, %legup_memset_4_i64.exit
  %116 = phi i32 [ 0, %legup_memset_4_i64.exit ], [ %122, %113 ]
  %117 = add i32 %116, 1
  %scevgep8 = getelementptr [30 x i32]* @decis_levl, i32 0, i32 %116
  %118 = load i32* %scevgep8, align 4, !tbaa !1
  %119 = mul nsw i32 %118, %detl.0
  %120 = ashr i32 %119, 15
  %121 = icmp sgt i32 %m.0.i.i.i, %120
  %122 = add nsw i32 %116, 1
  br i1 %121, label %113, label %quantl.exit.i

quantl.exit.i:                                    ; preds = %115, %113
  %mil.0.lcssa.i.i = phi i32 [ %116, %115 ], [ %117, %113 ]
...
adpcm_main.exit:                                  ; preds = %adpcm_main.exit, %adpcm_main.exit.preheader
  ...
  %455 = phi i32 [ %460, %adpcm_main.exit ], [ 0, %adpcm_main.exit.preheader ]
  %scevgep3 = getelementptr [100 x i32]* @test_compressed, i32 0, i32 %455
  %scevgep4 = getelementptr [100 x i32]* @compressed, i32 0, i32 %455
  %456 = load i32* %scevgep4, align 4, !tbaa !1
  %457 = load i32* %scevgep3, align 4, !tbaa !1
  %458 = icmp eq i32 %456, %457
  %459 = zext i1 %458 to i32
  %.main_result.0 = add nsw i32 %459, %main_result.04
  %460 = add nsw i32 %455, 1
  %exitcond = icmp eq i32 %460, 50
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %461 = phi i32 [ %466, %.preheader ], [ 0, %.preheader.preheader ]
  %scevgep = getelementptr [100 x i32]* @test_result, i32 0, i32 %461
  %scevgep2 = getelementptr [100 x i32]* @result, i32 0, i32 %461
  %462 = load i32* %scevgep2, align 4, !tbaa !1
  %463 = load i32* %scevgep, align 4, !tbaa !1
  %464 = icmp eq i32 %462, %463
  %465 = zext i1 %464 to i32
  %.main_result.2 = add nsw i32 %465, %main_result.22
  %466 = add nsw i32 %461, 1
  %exitcond1 = icmp eq i32 %466, 100
  br i1 %exitcond1, label %467, label %.preheader

; <label>:467                                     ; preds = %.preheader
  %.main_result.2.lcssa = phi i32 [ %.main_result.2, %.preheader ]
  %468 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.main_result.2.lcssa) #1
  %469 = icmp eq i32 %.main_result.2.lcssa, 150
  br i1 %469, label %470, label %472

; <label>:470                                     ; preds = %467
  %471 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1
  br label %474

; <label>:472                                     ; preds = %467
  %473 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1
  br label %474
